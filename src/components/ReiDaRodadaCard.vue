  ...
  <div class="fixed top-0 left-0 -z-50 opacity-0 pointer-events-none">
    ...
    >
      ...
      <div class="absolute inset-0 z-0">
        <div class="absolute top-[-10%] left-[-10%] w-[60%] h-[60%] bg-copa-accent/30 rounded-full blur-[120px]"></div>
        <div class="absolute bottom-[-10%] right-[-10%] w-[60%] h-[60%] bg-copa-gold/20 rounded-full blur-[120px]"></div>
      ...
      <div class="relative z-10 flex flex-col items-center mt-20">
        <div class="text-copa-gold text-8xl mb-6 drop-shadow-lg">👑</div>
        <h1 class="text-7xl font-black text-white text-center tracking-tight mb-4 uppercase">
          Rei da Rodada
        </h1>
        <div class="text-3xl text-copa-accent-light font-medium tracking-widest bg-white/10 px-8 py-3 rounded-full backdrop-blur-sm">
          {{ formattedDate }}
        </div>
      </div>
      ...
      <div class="relative z-10 flex flex-col items-center justify-center flex-1">
        ...
        <div class="flex items-end gap-4 mb-8">
          <span class="text-[120px] font-black text-copa-gold leading-none drop-shadow-lg">
            {{ player.pontos }}
          </span>
          <span class="text-4xl text-copa-gold/80 font-bold mb-4 uppercase tracking-widest">
            Pontos
          </span>
        </div>
        ...
        <div class="grid grid-cols-2 gap-8 w-full max-w-2xl">
          <div class="bg-white/5 backdrop-blur-md rounded-3xl p-8 border border-white/10 text-center flex flex-col items-center">
            <div class="text-5xl mb-4">🎯</div>
            <div class="text-4xl font-black text-white mb-2">{{ player.acertos_exatos || 0 }}</div>
            <div class="text-xl text-slate-400 font-medium uppercase tracking-wider">Na Mosca</div>
          </div>
          <div class="bg-white/5 backdrop-blur-md rounded-3xl p-8 border border-white/10 text-center flex flex-col items-center">
            <div class="text-5xl mb-4">✅</div>
            <div class="text-4xl font-black text-white mb-2">{{ player.acertos_vencedor || 0 }}</div>
            <div class="text-xl text-slate-400 font-medium uppercase tracking-wider">Acertos</div>
          </div>
        </div>
